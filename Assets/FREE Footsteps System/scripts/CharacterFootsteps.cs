...
namespace Footsteps
{
    ...
    public class CharacterFootsteps : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (triggeredBy == TriggeredBy.TRAVELED_DISTANCE && !characterRigidbody && !characterController) errorMessage = "Please assign a Rigidbody or CharacterController component in the inspector, footsteps cannot be played";
        ...
        void PlayLandSound()
        {
            ...
            EazySoundManager.PlaySound(SurfaceManager.singleton.GetFootstep(currentGroundInfo.collider, currentGroundInfo.point));
        }
        ...
        void PlayFootstep()
        {
            ...
            if (randomFootstep)
            {
                ...
                EazySoundManager.PlaySound(randomFootstep, randomVolume);
            }
        }
